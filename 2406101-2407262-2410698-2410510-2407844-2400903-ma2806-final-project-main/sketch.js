...
function setup() {
    ...
    // Creating player
    player = new Player(playerSprite, 0, 4, tileSize, playerSpeed, tileSize, batterySprite,gunSprite)
...
function addTransitionsToTiles() {
    if (currentLevel === beginningObject) {
        currentLevel.tileRules [0][8] = transitionBeginningToMiddle;
    }
   
    if (currentLevel === beginningObject) {
        currentLevel.tileRules [9][2] = transitionMiddleToBeginning;
        currentLevel.tileRules [0][2] = transitionMiddleToFinal;
    }

    if (currentLevel === beginningObject) {
        currentLevel.tileRules [9][2] = transitionFinalToMiddle;
    }
}
...
class Player {
    constructor(sprite, startAcross, startDown, size, speed, tileSize, gunSprite,batterySprite) {
